...
function displayStats() {
    ...
    reportEl.textContent = `You have changed the head ${headCount} times, the body ${middleCount} times, and the pants ${bottomCount} times. And you're awesome character catchphrases!:`;
}
